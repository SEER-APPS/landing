  ...
  controlCards: [
    {
      ...
      body: "End-to-end protection keeps personal conversations inside the chat. No one outside the chat, not even Seer, can open the protected content.",
    ...
    },
    {
      id: "mediaTimers",
      title: "Private media timers",
      body: "Choose one-time viewing or a 24-hour timer when sending supported photos, videos, and voice notes.",
      learnMoreHref: "/privacy",
      learnMoreLabel: "Learn more",
    },
    {
      ...
      body: "Spot something off? Report a message or block a contact so unwanted people can’t keep reaching you.",
